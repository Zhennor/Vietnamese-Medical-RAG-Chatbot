    ...
    def build_query_prompt(self, original_query: str):
        prompt = ChatPromptTemplate.from_messages(
            [
                ...
                ("human", f"Vui lòng tạo ra 4 câu truy vấn tìm kiếm liên quan nhất đến: {original_query}. Chỉ trả về 4 câu truy vấn và không có dấu đặc biệt ở trước từng query, không giải thích gì thêm.")
            ]
        )
        return prompt
